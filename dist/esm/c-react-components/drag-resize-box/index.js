...
var DragResizeBox = /*#__PURE__*/ React.memo(function (props) {
  var children = props.children,
    ...
    guidesColor =
      _props$guidesColor === void 0 ? 'rgb(0, 120, 212)' : _props$guidesColor;
  var box = useRef(null);
  // 用来记录鼠标点下去时元素的属性值
  ...
  var hiddenLine = useCallback(function () {
    [line_n, line_e, line_s, line_w, line_mdx, line_mdy].forEach(function (
      line,
    ) {
      line.current.hidden = true;
    });
  }, []);
  var handleLines = useCallback(
    function (curCalcRect) {
   ...
   * 收集所有相同移动盒子的 rect 属性
   */
  var collectAllBoxRect = useCallback(
    function () {
      var _box$current;
      allBoxRectCollector.current = [];
      //其他所有相同的移动盒子
      var allBoxes = Array.from(
        (relative
          ? (_box$current = box.current) === null || _box$current === void 0
            ? void 0
            : _box$current.parentElement
          : document
        ).querySelectorAll('.dragResizeBox'),
      );
      for (var _i2 = 0, _allBoxes = allBoxes; _i2 < _allBoxes.length; _i2++) {
        var boxItem = _allBoxes[_i2];
  ...
  var _onMouseDown = useCallback(function (e, currentDirection) {
    ...
    if (relative) {
      ...
      left =
        (_box$current2 = box.current) === null || _box$current2 === void 0
          ? void 0
          : _box$current2.offsetLeft;
      top =
        (_box$current3 = box.current) === null || _box$current3 === void 0
          ? void 0
          : _box$current3.offsetTop;
    } else {
    ...
    right =
      left +
      ((_box$current4 = box.current) === null || _box$current4 === void 0
        ? void 0
        : _box$current4.offsetWidth);
    bottom =
      top +
      ((_box$current5 = box.current) === null || _box$current5 === void 0
        ? void 0
        : _box$current5.offsetHeight);

    // 获取元素矩阵大小
    var _ref2 =
        (_box$current6 = box.current) === null || _box$current6 === void 0
          ? void 0
          : _box$current6.getBoundingClientRect(),
      width = _ref2.width,
      height = _ref2.height;
    // 存下鼠标点击后的鼠标坐标
    var pointX = e.pageX,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      'div',
      {
        ref: box,
        style: _objectSpread(
          _objectSpread(_objectSpread({}, style), rect),
          rectAttr,
        ),
        className: 'dragResizeBox '
          .concat(allowResize ? 'checked' : '', ' ')
          .concat(className),
        onClick: onChecked,
      },
