...
var DynamicTable = function DynamicTable(props) {
  var rowKey = props.rowKey,
    ...
    tableSave = props.tableSave,
    _props$normalShow = props.normalShow,
    normalShow = _props$normalShow === void 0 ? true : _props$normalShow,
    other = _objectWithoutProperties(props, _excluded);
  var _useState = useState(data || []),
    _useState2 = _slicedToArray(_useState, 2),
    dataSource = _useState2[0],
    setDataSource = _useState2[1];
  var _useState3 = useState(data && data.length ? data.length + 1 : 1),
  ...
  var handleAdd = function handleAdd() {
    var newData = columns.reduce(function (prev, cur) {
      prev['key'] = count;
      prev[cur.key] = '';
      return prev;
    }, {});
    ...
    columns.map(function (item) {
      if (item.type === 'action') {
        ...
        (item.key = 'controlOperation'),
          (item.render = function (rowText, record, rowIndex) {
            var renderTableButtonGroup = function renderTableButtonGroup(
              buttonGroup,
            ) {
              if (!buttonGroup) return '-';
              var recombinationGroup = []; // 重组数据
            ...
            var handleDelete = function handleDelete(text) {
        ...
        item.render = function (rowText, record, rowIndex) {
          return rowText || rowText === 0 ? rowText : '-';
        };
        return item;
      }
      return item;
      ...
      {},
      {
        onCell: function onCell(record) {
          return {
            ...
            title: col.title,
            required: col === null || col === void 0 ? void 0 : col.required,
            type: col === null || col === void 0 ? void 0 : col.type,
            fieldOptions:
              col === null || col === void 0 ? void 0 : col.fieldOptions,
            icon: col === null || col === void 0 ? void 0 : col.icon,
            btnContext:
              col === null || col === void 0 ? void 0 : col.btnContextm,
            valuePropName:
              col === null || col === void 0 ? void 0 : col.valuePropName,
...
var EditableCell = function EditableCell(props) {
  var _props$normalShow2 = props.normalShow,
    normalShow = _props$normalShow2 === void 0 ? true : _props$normalShow2,
    title = props.title,
    ...
    childNode = editing
      ...
      : /*#__PURE__*/ React.createElement(
          ...
          normalShow && Array.isArray(children) && type !== 'upload'
            ...
            ? record[dataIndex].map(function (item, index) {
            ...
            : type === 'tag' &&
              ...
              record[dataIndex].length > 0
            ? record[dataIndex].map(function (item, index) {
                var color = index > 4 ? 'geekblue' : 'green';
                if (item === 'loser') {
                  color = 'volcano';
                }
                return /*#__PURE__*/ React.createElement(
