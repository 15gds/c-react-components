...
var myChart = null;
var ChartsComp = /*#__PURE__*/React__default['default'].memo(function (props) {
...
var DragResizeBox = /*#__PURE__*/React__default['default'].memo(function (props) {
  ...
  var allBoxRectCollector = React.useRef([]);
  // 方向
  var direction = React.useRef('left');
  // 辅助线
  ...
  var line_mdy = React.useRef(null);
  ...
  var onCancelChecked = React.useCallback(function (e) {
    var isChild = box.current.contains(e.target);
    if (!isChild) {
      setAllowResize(false);
    }
  }, []);
  var onChecked = React.useCallback(function () {
  ...
  var handleLines = React.useCallback(function (curCalcRect) {
  ...
  var handleLimit = React.useCallback(function (rect, limit) {
    var left = rect.left,
      top = rect.top,
      width = rect.width,
      height = rect.height;
...
exports.ChartsComp = ChartsComp;
exports.DragResizeBox = DragResizeBox;
